...
> & {
    order: Maybe<{ __typename?: 'Order' } & Pick<Order, 'id' | 'orderNumber'>>;
    discountApplications: { __typename?: 'DiscountApplicationConnection' } & {
      edges: Array<
        { __typename?: 'DiscountApplicationEdge' } & {
          node: {
            __typename?:
  ...
  checkoutCreate: Maybe<
    { __typename?: 'CheckoutCreatePayload' } & {
      userErrors: Array<
        { __typename?: 'UserError' } & Pick<UserError, 'field' | 'message'>
      >;
      checkout: Maybe<{ __typename?: 'Checkout' } & CheckoutStateFragment>;
  ...
  node: Maybe<
    {
      ...
      ({ __typename?: 'Checkout' } & CheckoutStateFragment)
  >;
};
