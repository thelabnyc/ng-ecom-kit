...
export type Cart = Node & {
   ...
   * `estimatedCost` field uses the `buyerIdentity` field to determine [international pricing](https://shopify.dev/api/examples/international-pricing#create-a-cart).
   **/
...
export type CartInput = {
  ...
  note?: Maybe<Scalars['String']>;
  /**
   * The customer associated with the cart. Used to determine [international pricing](https://shopify.dev/api/examples/international-pricing#create-a-checkout).
...
export type FullDiscountAllocationFragment = {
  __typename?: 'CartAutomaticDiscountAllocation' | 'CartCodeDiscountAllocation';
} & {
  discountedAmount: { __typename?: 'MoneyV2' } & Pick<
    MoneyV2,
    'amount' | 'currencyCode'
  >;
} & (
...
export type LineItemPropertiesFragment = { __typename?: 'CartLine' } & Pick<
  CartLine,
  'id' | 'quantity'
> & {
    discountAllocations: Array<
      {
        __typename?:
          | 'CartAutomaticDiscountAllocation'
          | 'CartCodeDiscountAllocation';
      } & FullDiscountAllocationFragment
    >;
...
> & {
    ...
    lines: { __typename?: 'CartLineConnection' } & {
      edges: Array<
        { __typename?: 'CartLineEdge' } & {
          node: { __typename?: 'CartLine' } & LineItemPropertiesFragment;
        }
      >;
    };
  };
    ...
    { __typename?: 'CartBuyerIdentityUpdatePayload' } & {
      ...
      cart: Maybe<
        { __typename?: 'Cart' } & Pick<Cart, 'id'> & {
            buyerIdentity: { __typename?: 'CartBuyerIdentity' } & {
              customer: Maybe<
...
export type CheckoutDiscountCodeApplyV2MutationVariables = {
  discountCode: Scalars['String'];
  checkoutId: Scalars['ID'];
};
...
export type CheckoutDiscountCodeRemoveMutationVariables = {
  checkoutId: Scalars['ID'];
};

export type CheckoutDiscountCodeRemoveMutation = { __typename?: 'Mutation' } & {
  cartDiscountCodesUpdate: Maybe<
    { __typename?: 'CartDiscountCodesUpdatePayload' } & {
      userErrors: Array<
        { __typename?: 'CartUserError' } & Pick<
...
export const FullDiscountAllocationFragmentDoc = gql`
...
export const LineItemPropertiesFragmentDoc = gql`
  ...
  ${FullDiscountAllocationFragmentDoc}
`;
...
export class CartLinesRemoveGQL extends Apollo.Mutation<
  CartLinesRemoveMutation,
  CartLinesRemoveMutationVariables
> {
  document = CartLinesRemoveDocument;
}
...
export class CartLinesUpdateGQL extends Apollo.Mutation<
  CartLinesUpdateMutation,
  CartLinesUpdateMutationVariables
> {
  document = CartLinesUpdateDocument;
}
